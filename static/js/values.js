...
value('translation', {
    'off': 'kapalı',
    'on': 'açık',
    'syntax': 'Sözdizimi Renklendirmesi',
    ...
    'submit-feedback': 'Bu sayfa hakkında geri bildirimde bulun',

    // GitHub issue template: update repo and messaging when translating.
    'github-repo': 'github.com/golang-tr/tour',
    'issue-title': 'tur: [KISA AÇIKLAMA İLE DEĞİŞTİRİN]',
    'issue-message': 'Yukarıdaki başlığı sorunu tarif edecek şekilde değiştirin ve geri bildiriminizi (gerekiyorsa ilgili kodla birlikte) buraya ekleyin',
    'context': 'Bağlam',
}).
